...
"""
Plugin for Mega Man Battle Network 2 (GBA)
Stub - a character table is needed.

Game codes: AM2P (Europe)
...
logger = logging.getLogger('gb2text.plugins.megaman_battle_network_2')

GAME_CODES = ['AM2P']


class MegaManBattleNetwork2Plugin(GamePlugin):
    """Plugin for Mega Man Battle Network 2 (GBA)"""
    ...
    def get_text_segments(self, rom: GameBoyROM) -> list[dict]:
        logger.info("STUB: таблица символов для Mega Man Battle Network 2 не реализована")
        return []
