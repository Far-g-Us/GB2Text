...
"""
Plugin for Metroid: Zero Mission (GBA)
...
logger = logging.getLogger('gb2text.plugins.metroid_zero_mission')

GAME_CODES = ['BMXE']


class MetroidZeroMissionPlugin(GamePlugin):
    """Plugin for Metroid: Zero Mission (GBA)"""
    ...
    def get_text_segments(self, rom: GameBoyROM) -> list[dict]:
        logger.info("STUB: таблица символов для Metroid: Zero Mission не реализована")
        return []
