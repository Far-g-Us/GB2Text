...
class ValidationError:
    ...
    def __init__(self, level: ValidationLevel, message: str, field: str | None = None, segment_id: str | None = None):
        self.level = level
...
class TranslationValidator:
    ...
    def __init__(self, max_length: int = 255, check_glyphs: bool = True):
        ...
        self.allowed_glyphs: set | None = None

    def set_allowed_glyphs(self, glyphs: set):
        """Устанавливает набор разрешённых глифов"""
        self.allowed_glyphs = glyphs

    def validate(self, original: str, translation: str, segment_id: str | None = None) -> ValidationResult:
        """
    ...
    def _validate_length(self, text: str, segment_id: str | None = None) -> ValidationResult:
    ...
    def _validate_control_chars(self, text: str, segment_id: str | None = None) -> ValidationResult:
        """Проверка управляющих символов"""
        errors = []
        ...
        if matches:
            ...
            char_set = {ord(c) for c in matches}
    ...
    def _validate_spaces(self, text: str, segment_id: str | None = None) -> ValidationResult:
        """Проверка пробелов"""
        errors: list[ValidationError] = []
        warnings: list[ValidationError] = []
    ...
    def _validate_pointers(self, text: str, segment_id: str | None = None) -> ValidationResult:
    ...
    def _validate_glyphs(self, text: str, segment_id: str | None = None) -> ValidationResult:
...
_global_validator: TranslationValidator | None = None
