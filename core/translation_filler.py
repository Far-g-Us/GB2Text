...
class TranslationFiller:
    ...
    def __init__(self, options: FillOptions | None = None):
...
_global_filler: TranslationFiller | None = None

def get_filler(options: FillOptions | None = None) -> TranslationFiller:
